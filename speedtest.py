...
def display_text(stdscr, target, current, wpm=0):
    stdscr.addstr(0, 0, target)  # Display the target text
    stdscr.addstr(1, 0, f"WPM: {wpm}")  # Display the WPM
    ...
    for i, char in enumerate(current):
        ...
        stdscr.addstr(0, i, char, color)  # Display current input with color
...
def main(stdscr):
    ...
    curses.init_pair(3, curses.COLOR_WHITE, curses.COLOR_BLACK)  # Additional color if needed
